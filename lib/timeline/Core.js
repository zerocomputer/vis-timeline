...
class Core {
  ...
  setOptions(options) {
    ...
    } else if (!this.options.direction || this.options.direction === "vertical") {
    ...
    if (options && this.options.direction) {
  ...
  _redraw() {
    ...
    if (options.vertical) {
      util.addClassName(dom.root, "vis-vertical");
    } else {
      util.removeClassName(dom.root, "vis-vertical");
    }
